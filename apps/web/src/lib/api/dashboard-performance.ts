...
export const dashboardPerformanceApi = { get: (benchmark: DashboardBenchmark, routeIds?: string[]) => apiFetch<DashboardPerformance>("/dashboard-performance", { query: { benchmark, ...(routeIds?.length ? { routeIds: routeIds.join(",") } : {}) } }) };
