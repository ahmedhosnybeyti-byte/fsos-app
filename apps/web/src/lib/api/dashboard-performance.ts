...
export const dashboardPerformanceApi = { get: (benchmark: DashboardBenchmark, routeIds?: string[], period?: { dateFrom?: string; dateTo?: string; comparisonFrom?: string; comparisonTo?: string }) => apiFetch<DashboardPerformance>("/dashboard-performance", { query: { benchmark, ...(routeIds?.length ? { routeIds: routeIds.join(",") } : {}), ...period } }) };
