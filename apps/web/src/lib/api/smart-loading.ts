...
export const smartLoadingApi = {
  getSession: (targetDate?: string, staleDaysThreshold?: number, salesRepId?: string, managerId?: string, supervisorId?: string, includeDeferredAnalysis?: boolean) => apiFetch<SmartLoadingSession>("/smart-loading/session", { query: { targetDate, staleDaysThreshold, salesRepId, managerId, supervisorId, includeDeferredAnalysis } }),
