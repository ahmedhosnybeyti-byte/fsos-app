...
import type { SmartLoadingCustomerSearchResult, SmartLoadingManagementQuery, SmartLoadingManagementResult, SmartLoadingRecalculateInput, SmartLoadingRecalculateResult, SmartLoadingSession } from "@field-sales-os/schemas";
...
export const smartLoadingApi = {
  ...
  getManagement: (query: SmartLoadingManagementQuery) => apiFetch<SmartLoadingManagementResult>("/smart-loading/management", { query }),
