...
export const smartLoadingApi = {
  ...
  getManagementLostOpportunities: (targetDate: string, limit = 100, offset = 0) => apiFetch<SmartLoadingManagementLostOpportunitiesResponse>("/smart-loading/management-risks/lost-opportunities", { query: { targetDate, limit, offset } }),
