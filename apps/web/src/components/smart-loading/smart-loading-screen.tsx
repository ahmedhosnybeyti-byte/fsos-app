...
function SmartLoadingPhaseTwo(props: SmartLoadingPhaseTwoProps) {
  ...
  return <>
    <section className="grid gap-3 lg:h-[22rem] lg:grid-cols-[3fr_2fr]" style={{ direction: "ltr" }}>
      <div dir={props.locale === "ar" ? "rtl" : "ltr"} className="order-1 grid min-h-0 gap-3 lg:col-start-2 lg:row-span-2 lg:grid-rows-[3fr_2fr]">
