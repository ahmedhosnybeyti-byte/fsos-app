...
function ManagementStockAlignmentMetric({ label, value, locale }: { label: string; value: number; locale: "ar" | "en" }) {
  ...
  return (
    <div className="flex min-w-0 items-center justify-between rounded-md bg-background/60 px-2 py-1.5">
      <div className="min-w-0">
...
function SmartLoadingPhaseTwo(props: SmartLoadingPhaseTwoProps) {
  ...
  const showManagementStockAlignment = isManagementRole(props.roleCode) && props.session.managementStockAlignmentPercent !== null;
