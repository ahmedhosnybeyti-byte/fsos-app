...
export default function AdminCompaniesPage() {
  ...
  const { data, isLoading } = useQuery({ queryKey: ["admin", "companies", page, search], queryFn: () => companiesApi.list(page, 20, search || undefined) });
