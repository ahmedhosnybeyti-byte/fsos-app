    ...
    <div className="relative isolate space-y-6">
      ...
      <div className="glass-hero rise-in flex items-center gap-4 bg-gradient-to-l from-primary/15 via-transparent to-ai/15 p-5 sm:p-7">
        ...
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold tracking-tight sm:text-3xl">{t("newCustomer.title")}</h1><p className="mt-1 text-sm text-muted-foreground">{t("newCustomer.subtitle")}</p>
        </div>
      </div>
