...
export default function RoutePlanningPage() {
  ...
  return (
    <div key={locale} className="relative isolate space-y-6 bg-slate-50/40 dark:bg-transparent">
      ...
      <div className="glass-hero rise-in flex items-center gap-4 bg-[linear-gradient(115deg,rgba(255,255,255,.94),rgba(219,234,254,.92),rgba(237,233,254,.9))] p-5 dark:bg-gradient-to-l dark:from-primary/15 dark:via-transparent dark:to-ai/15 sm:p-7">
        ...
        <div>
          <p className="text-xs font-semibold tracking-[0.16em] text-primary/90">MURSHIDAK · TERRITORY INTELLIGENCE</p>
          <h1 className="mt-1 text-2xl font-bold tracking-tight sm:text-3xl">{t("routePlanning.title")}</h1>
          <p className="mt-1 text-sm text-muted-foreground">{t("routePlanning.subtitle")}</p>
        </div>
      </div>
