...
export default function DashboardOverviewPage() {
  ...
  return (
    <div dir={locale === "ar" ? "rtl" : "ltr"} className="relative space-y-6">
...
function DashboardStat({ label, value, className }: { label: string; value: string; className?: string }) { return <div className="px-3 first:pe-0 last:ps-0"><p className="text-xs text-muted-foreground">{label}</p><p className={`mt-2 text-lg font-bold tabular-nums ${className ?? ""}`}>{value}</p></div>; }
