...
export const NEED_TAXONOMY: readonly NeedDefinition[] = [
  ...
  { tag: "hotel-housekeeping", businessTypes: ["hotel"], menuTags: ["hotel-housekeeping"], categoryTerms: ["cleaning", "housekeeping"], productTerms: ["cleaner", "detergent"] },
  { tag: "hotel-hygiene", businessTypes: ["hotel"], menuTags: ["hotel-hygiene"], categoryTerms: ["tissue", "hygiene"], productTerms: ["tissue", "paper"] },
  { tag: "hotel-food-service", businessTypes: ["hotel"], menuTags: ["hotel-food-service"], categoryTerms: ["food", "breakfast"], productTerms: [] },
