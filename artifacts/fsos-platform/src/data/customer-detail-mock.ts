...
export const CUSTOMER_DETAIL_MAP: Record<number, CustomerDetailData> = {
  1: {
    ...
    todayDecision: {
      ...
      context: "FSOS AI detected 3 previous visits where collection was deferred. This is the 4th opportunity. Credit hold is imminent at AED 75,000 limit — current exposure is 17%.",
  ...
  2: {
    ...
    todayDecision: {
      ...
      context: "FSOS AI identified a premium SKU gap worth AED 3,600/month. Zone benchmark shows 8 out of 10 Spinneys stores carry the Ariel Eco-Organic range.",
